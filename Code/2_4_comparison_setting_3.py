...
ax1.legend()
fig1.savefig("figures/2_4_heteroscedastic_noise_RF.png")
plt.show()
...
ax2.legend()
fig2.savefig("figures/2_4_heteroscedastic_noise_LW.png")
plt.show()
...
ax3.legend()
fig3.savefig("figures/2_4_heteroscedastic_noise_CQR.png")
plt.show()