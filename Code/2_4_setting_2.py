...
# Setting 2 -------------- Heteroscedastic setting ------------------------
def mu(x, a, b):
    return a + b*x
...
ax1.legend()
plt.show()
fig1.savefig("2_4_heteroscedastic_RF.png")
...
ax2.legend()
plt.show()
fig2.savefig("2_4_heteroscedastic_LW.png")
...
ax3.legend()
plt.show()
fig3.savefig("2_4_heteroscedastic_CQR.png")
...
ax4.legend()
plt.show()
fig4.savefig("2_4_heteroscedastic_lens_dist.png")